...
1. **基板のセット**:
   - USB ポートの位置をボトムケースの開口部に合わせて差し込み、四隅のスタンドオフボス上に水平に載せます。
2. **トップカバーの装着**:
   - 合わせ目リップ（凸凹）を合わせて、上からトップカバーを被せます。
3. **M2 ネジによる貫通固定**:
   - 天面の 4 箇所のザグリ穴から **M2 × 12mm 〜 16mm なべネジ** を挿入し、ドライバーでボトムケースのネジ穴にねじ込んで均等に締め付けます。
